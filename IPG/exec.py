...
if __name__ == '__main__':
    ...
    # eval from folder
    parser.add_argument('--eval_folder', type=str, default=None)  # Our note: if set, will eval from the given folder (pth, weights file)

    # eval opt
    parser.add_argument('--eval_opt', type=str, default=None)  # Our note: if None, will use the default eval json path. Otherwise, give a yml file from the "options" folder.
