...
|----------|------------------------|-----|-----|-------------------|
| `adaptive` | 0.2081 ± 0.1047 | 0.0608 | 0.4163 | 90.00% |
...
|----------|-----------------|-------------------|----------------|-------------------|
| `baseline_tfidf` | **+-56.35%** | +-55.46% | 3/10 | **30.0%** |
| `baseline_keyword` | **+1123.43%** | +664.45% | 10/10 | **100.0%** |

### Best Improvements Summary

| Strategy | vs Baseline | Improvement | Queries Better |
|----------|-------------|-------------|----------------|
| `adaptive` | `baseline_keyword` | **+1123.43%** | **100.0%** |
...
|----------|-------------|-----------------|-------------|---------|--------------|
| `adaptive` | `baseline_tfidf` | -0.1243 | -1.4053 | 0.193484 | **✗** |
...
2. **Baseline Comparison**: The system demonstrates substantial improvements over 
   ...
   - `adaptive`: **533.5%** average improvement over baselines
