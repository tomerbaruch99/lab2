...
- Average Score: `0.2327` (±0.3270)

## Overall Performance Statistics

| Strategy | Avg Score (Mean ± Std) | Min | Max | Namespace Accuracy |
|----------|------------------------|-----|-----|-------------------|
| `adaptive` | 0.2214 ± 0.1091 | 0.0686 | 0.4163 | 90.00% |
...
|----------|-----------------|-------------------|----------------|-------------------|
| `baseline_tfidf` | **+-48.30%** | +-52.97% | 6/10 | **60.0%** |
| `baseline_keyword` | **+1029.15%** | +561.14% | 10/10 | **100.0%** |

### Best Improvements Summary

| Strategy | vs Baseline | Improvement | Queries Better |
|----------|-------------|-------------|----------------|
| `adaptive` | `baseline_keyword` | **+1029.15%** | **100.0%** |
...
|----------|-------------|-----------------|-------------|---------|--------------|
| `adaptive` | `baseline_tfidf` | -0.0113 | -0.1177 | 0.908911 | **✗** |
...
2. **Baseline Comparison**: The system demonstrates substantial improvements over 
   ...
   - `adaptive`: **490.4%** average improvement over baselines
