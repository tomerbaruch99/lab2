...
- Average Score: `0.2495` (±0.1126)

## Overall Performance Statistics

| Strategy | Avg Score (Mean ± Std) | Min | Max | Namespace Accuracy |
|----------|------------------------|-----|-----|-------------------|
| `adaptive` | 0.2495 ± 0.1126 | 0.0686 | 0.4163 | 90.00% |
...
|----------|-----------------|-------------------|----------------|-------------------|
| `baseline_tfidf` | **+-40.12%** | +-40.42% | 6/10 | **60.0%** |
| `baseline_keyword` | **+1079.45%** | +561.14% | 10/10 | **100.0%** |

### Best Improvements Summary

| Strategy | vs Baseline | Improvement | Queries Better |
|----------|-------------|-------------|----------------|
| `adaptive` | `baseline_keyword` | **+1079.45%** | **100.0%** |
...
|----------|-------------|-----------------|-------------|---------|--------------|
| `adaptive` | `baseline_tfidf` | +0.0168 | 0.1756 | 0.864477 | **✗** |
...
2. **Baseline Comparison**: The system demonstrates substantial improvements over 
   ...
   - `adaptive`: **519.7%** average improvement over baselines
