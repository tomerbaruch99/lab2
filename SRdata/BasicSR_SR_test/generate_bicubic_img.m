...
input_folder = [dataset, '/original']; %'Set14/original';
save_mod_folder =  [dataset, '/GTmod', scale]; %'Set14/GTmod2';
save_lr_folder =  [dataset, '/LRbicx', scale]; %'Set14/LRbicx2';
% save_bic_folder = '';

mod_scale = str2num(scale);
up_scale = str2num(scale);
